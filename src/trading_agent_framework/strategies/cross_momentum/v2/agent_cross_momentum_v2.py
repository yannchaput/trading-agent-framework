"""
Cross-Sectional Momentum Strategy (V2)
-------------------------------------
Canonical V2 strategy — the baseline for all V2.x variants.
...
class CrossMomentumStrategyV2(WrappingStrategy):
    """Cross-sectional momentum strategy V2 — the canonical baseline.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.log_message(
            f"CrossMomentumStrategyV2 initialized with {len(self.__universe)} symbols",
            color="green",
        )
    ...
    def initialize(self):
        ...
        # Track actual portfolio equity for realized-vol computation
        self._equity_history = load_equity_history()
        self.log_message(f"Initialize equity history for volatility exposure compute {self._equity_history}", color="green")
    ...
    def on_trading_iteration(self):
        ...
        self.log_message("Today is a rebalance day — computing target portfolio...", color="green")
