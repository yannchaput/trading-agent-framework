...
----------------------------------
Pure rules-based weekly cross-sectional momentum strategy.
No LLM, no AI agents in v1.
...
class CrossMomentumStrategyV1(WrappingStrategy):
    """Cross-sectional momentum strategy — weekly rebalance, no AI agents in v1.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            universe: List of ticker symbols. If None, loads from the default
                      universe JSON file (data/universe/stock_universe.json).
        """
